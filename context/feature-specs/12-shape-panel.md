...
1. Add a floating pill-shaped toolbar at the bottom of the canvas.
...
3. When dragging a shape, include the shape name and default size in the drag payload.
    ...
    - rectangles should be winder the tall
...
- Drop login creates a new canvas with the expected shape data.
