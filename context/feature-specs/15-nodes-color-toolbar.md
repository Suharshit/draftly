...
2. Add a toolbar above selected nodes.
    ...
    - hovering a swatch show a subtle glow based on its text color
    - keep the glow tight and controlled, not overly blurred
    - prevent toolbar interactions from dragging node or panning the canvas
...
4. Selected noded should visually reflect their active color pair.
