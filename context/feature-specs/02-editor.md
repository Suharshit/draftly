We need the base code component that frames every editor screen, the top nav and the left side shell. These will be re-used and extended in every chapter that follows.
